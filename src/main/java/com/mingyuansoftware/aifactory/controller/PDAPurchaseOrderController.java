...
public class PDAPurchaseOrderController {
    ...
    @RequestMapping(value = "/getPDaPurchaseOrderTaskList", method = RequestMethod.GET)
    @ResponseBody
    public CommonResponse getPDaPurchaseOrderTaskList(@Validated @RequestParam(defaultValue = "1") int page,
        ...
        try {
            ...
            List<PDAPurchaseStorageTask> pDaPurchaseOrderTaskList =purchaseOrderService.selectPDaPurchaseOrderTaskList();
        ...
        try {
            ...
            if(!(pdaPurchaseOrderDtoList.isEmpty())){
                for(PDAPurchaseOrderDto pdaPurchaseOrderDto:pdaPurchaseOrderDtoList1){
                    ...
                    pdaPurchaseOrderDto.setWarehouseId(1);  //原料仓库Id
                    //添加库存
