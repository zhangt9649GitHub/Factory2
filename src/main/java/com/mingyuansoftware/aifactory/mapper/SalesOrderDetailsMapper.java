...
public interface SalesOrderDetailsMapper {
     ...
     * @return
     */
    int selectSalesReturnGoodsCount(@Param("salesOrderId") int salesOrderId,@Param("partsCd") String partsCd,@Param("goodsName") String goodsName);
     ...
     * @return
     */
    List<SalesOrderDetails> selectSalesReturnGoodsList(@Param("salesOrderId") int salesOrderId,@Param("partsCd") String partsCd,@Param("goodsName") String goodsName);
