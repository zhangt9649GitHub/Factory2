...
public class RefundPicking implements Serializable {
    ...
    @ApiModelProperty(value = "领入仓库id", example = "1")
    private Integer intoWarehouseId;

    @ApiModelProperty(value = "领出仓库id", example = "1")
    ...
    @ApiModelProperty(value = "退料单详情", example = "refundPickingDetailsList")
    private List<RefundPickingDetails> refundPickingDetailsList;
    ...
    public void setRefundPickingNumber(String refundPickingNumber) {
        this.refundPickingNumber = refundPickingNumber == null ? null : refundPickingNumber.trim();
    }
    ...
    public List<RefundPickingDetails> getRefundPickingDetailsList() {
        return refundPickingDetailsList;
    }

    public void setRefundPickingDetailsList(List<RefundPickingDetails> refundPickingDetailsList) {
        this.refundPickingDetailsList = refundPickingDetailsList;
    }
    ...
    public String toString() {
        ...
        sb.append(", refundPickingNumber=").append(refundPickingNumber);
