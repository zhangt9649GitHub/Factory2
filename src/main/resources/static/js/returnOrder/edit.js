...
layui.use(['form', 'table', 'layer', 'laydate'], function() {
	...
	axios.all([getWarehouseNameList(),getSerialNumberList()])
	...
	form.on('submit(*)', function(data) {
		...
		axios.post('/refundPicking/updateRefundPickingInfo', data.field)
			.then(function (response) {
