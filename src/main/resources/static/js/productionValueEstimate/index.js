...
$(document).ready(function() {
	layui.use(['form', 'table', 'layer','laydate'], function() {
		...
		table.render({
			...
			url: '/valueEstimation/getValueEstimationList',
			cols: [
				[
					...
					,{field: 'unfinishedQuantity',title: '计划数量',unresize: true}
					,{field: 'aPrice',title: '单价',unresize: true}
		...
		form.on('submit(*)', function(data) {
			...
			table.reload('idTest', {
				...
				where: {
					...
					unfinishedQuantity: $.trim(data.field.unfinishedQuantity),
