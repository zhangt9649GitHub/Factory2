<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/inboundOrder/add.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">新增-入库单 <span></span></h3>
					...
					<form action="" class="">
						...
						<div class="layui-row">
							<div class="layui-col-md6">
								<div class="zq-item">
									<label>编号：</label>
									<input type="text" name="storageNumber" readonly lay-verify="required" class="layui-input">
								</div>
							</div>
							<div class="layui-col-md6 zq-text-align-r">
								<div class="zq-item">
									<label>日期：</label>
									<input type="text" name="rukuTime" readonly lay-verify="required" class="layui-input" id="laydate-1">
								</div>
							</div>
							...
							<div class="layui-col-md4 zq-text-align-r">
								<div class="zq-item">
									<label>批号：</label>
									<input type="text" name="lotNumber" autocomplete="off" class="layui-input">
								</div>
							</div>
...
<script type="text/javascript" src="/static/js/inboundOrder/add.js"></script>
<!-- 添加删除图标按钮 -->
