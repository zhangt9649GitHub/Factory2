<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/salesOrders/add.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form" lay-filter="formTest">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">新增-销售订单 <span></span></h3>
...
<script type="text/javascript" src="/static/js/salesOrders/add.js"></script>
