<#include "../public_header.ftl">
	...
	<script type="text/javascript" src="/static/js/inventoryCheck/add.js"></script>
				...
				<div class="layui-row zq-form-wrap zq-margin-t30">
					<div class="layui-form-item layui-hide">
						...
						<div class="layui-input-block">
							<input type="text" name="staffId" value="${(Session.user.staffId)!''}" readonly lay-verify="required" class="layui-input"/>
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="inventoryCheckNumber" readonly lay-verify="required" class="layui-input"/>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">
