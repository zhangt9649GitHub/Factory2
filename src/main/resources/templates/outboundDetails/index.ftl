<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/outboundDetails/index.css">
	<script type="text/javascript" src="/static/js/outboundDetails/index.js"></script>
	...
	<div class="layui-row">
		<div class="bg-1 layui-card">
			<div class="layui-card-header layui-clear">
				<h3 class="left">出库明细 <span></span></h3>
