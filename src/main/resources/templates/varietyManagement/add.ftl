<#include "../public_header.ftl">
	...
	<script type="text/javascript" src="/static/js/varietyManagement/add.js"></script>
				...
				<div class="layui-row zq-form-wrap zq-margin-t30">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="varietyValue" lay-verify="required" class="layui-input"/>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="elName" class="layui-input"/>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">
						...
						<div class="layui-input-block">
							<input type="text" name="jpName" class="layui-input"/>
						</div>
					</div>
