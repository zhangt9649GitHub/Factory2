<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/payroll/add.css">
	<script type="text/javascript" src="/static/js/payroll/add.js"></script>
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form" lay-filter="formTest">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">新增-工资单 <span></span></h3>
