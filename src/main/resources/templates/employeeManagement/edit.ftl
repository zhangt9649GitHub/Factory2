<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/employeeManagement/edit.css">
	<script type="text/javascript" src="/static/js/employeeManagement/edit.js"></script>
