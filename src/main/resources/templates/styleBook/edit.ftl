<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/styleBook/edit.css">
	<script type="text/javascript" src="/static/js/styleBook/edit.js"></script>
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-式样书 <span></span></h3>
