<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/MRPOperation/index.css">
	<script type="text/javascript" src="/static/js/MRPOperation/index.js"></script>
	...
	<div class="layui-row">
		<div class="bg-1 layui-card">
			<div class="layui-card-header layui-clear">
				<h3 class="left">MRP运算 <span></span></h3>
				...
				<form class="layui-form zq-search-form">
					<div class="zq-search-wrap">
						<div class="zq-search search">
							...
							<div class="item">
								<button type="button"><i class="layui-icon layui-icon-search"></i></button>
								<input type="text" placeholder="请输入" autocomplete="off" class="layui-input" id="chuangjianshijian">
							</div>
...
<script type="text/html" id="bianhao">
	<a href="###" class="zq-active zq-open" data-href="/admin/MRPOperation/open" data-type="zq_newOpen">{{d.number}}</a>
</script>
<!-- 编号 -->
