<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/salesReturn/edit.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form" lay-filter="formTest">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-销售退货单 <span></span></h3>
...
<script type="text/javascript" src="/static/js/salesReturn/edit.js"></script>
<!-- 添加删除图标按钮 -->
