<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/purchaseOrder/editFinancialAmount.css">
	<script type="text/javascript" src="/static/js/purchaseOrder/editFinancialAmount.js"></script>
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form" lay-filter="formTest">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑财务金额-采购订单 <span></span></h3>
