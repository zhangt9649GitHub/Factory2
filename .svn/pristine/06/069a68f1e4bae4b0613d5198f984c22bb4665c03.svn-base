...
public class GoodsServiceImpl implements GoodsService {
    ...
    @Override
    public List<ProductionOrderGoods> selectProductionOrderGoodsList(String partsCd, String goodsName) {
        try{
          return goodsMapper.selectProductionOrderGoodsList(partsCd,goodsName);
        }catch (Exception e){
            e.printStackTrace();
        }
        return null;
    ...
    @Override
    public int selectProductionOrderGoodsCount(String partsCd, String goodsName) {
        try{
           return goodsMapper.selectProductionOrderGoodsCount(partsCd,goodsName);
        }catch (Exception e){
            e.printStackTrace();
        }
        return 0;
