<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/pickingList/add.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">新增-领料单 <span></span></h3>
...
<script type="text/javascript" src="/static/js/pickingList/add.js"></script>
