<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/purchaseRequisition/edit.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form" lay-filter="formTest">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-采购申请单 <span></span></h3>
			...
			<div class="layui-card-body">
				...
				<div class="zq-container zq-min-h800">
					...
					<form >
						<input type="hidden" name="purchaseApplyDetailsId" value="${purchaseApplyDetailsId}">
						<div class="layui-row">
...
<script type="text/javascript" src="/static/js/purchaseRequisition/edit.js"></script>
<!-- 添加删除图标按钮 -->
