<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/authorityManagement/edit.css">
	<script type="text/javascript" src="/static/js/authorityManagement/edit.js"></script>
				...
				<div class="layui-row zq-form-wrap zq-margin-t30">
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea name="groupText" class="layui-textarea"></textarea>
						</div>
