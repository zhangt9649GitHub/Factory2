...
//                goodsMapper.updateAPriceByGoodsId(purchaseOrderDetails.getGoodsId(),purchaseOrderDetails.getPurchasePrice());
    ...
    @Override
    public List<PurchaseOrderDetails> selectPurchaseOrderGoodsInsert(Integer supplierId,String partsCd,String goodsName) {
        try {
            return purchaseOrderMapper.selectPurchaseOrderGoodsInsert(supplierId,partsCd,goodsName);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    @Override
    public List<PDAPurchaseStorageTask> selectPDaPurchaseOrderTaskList() {
        try {
            return purchaseOrderMapper.selectPDaPurchaseOrderTaskList();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
