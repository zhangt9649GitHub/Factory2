<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/productionOrder/add.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">新增-排产单 <span></span></h3>
							...
							<div class="layui-col-md12">
								...
								<div class="layui-col-md6">
									<div class="zq-item">
										...
										<input type="text" name="staffName" value="${(Session.user.name)!''}">
									</div>
								</div>
							</div>
...
<script type="text/javascript" src="/static/js/productionOrder/add.js"></script>
<!-- 添加删除图标按钮 -->
