<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/purchaseOrder/edit.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form" lay-filter="formTest">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-采购订单 <span></span></h3>
				<div class="zq-btn-list">
					<button class="layui-btn green zq-active"  lay-submit lay-filter="*">提交</button>
					<button class="layui-btn green zq-active" type="button" data-type="confirmContract">确认合同</button>
...
<script type="text/javascript" src="/static/js/purchaseOrder/edit.js"></script>
