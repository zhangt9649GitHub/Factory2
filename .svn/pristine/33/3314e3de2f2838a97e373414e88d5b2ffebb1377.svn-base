<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/customerManagement/edit.css">
	<script type="text/javascript" src="/static/js/customerManagement/edit.js"></script>
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-客户信息 <span></span></h3>
