<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/inventoryCheck/edit.css">
	<script type="text/javascript" src="/static/js/inventoryCheck/edit.js"></script>
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 ">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-盘点单 <span></span></h3>
