<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/listOfProductStructure/add.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">新增-产品结构表 <span></span></h3>
...
<script type="text/javascript" src="/static/js/listOfProductStructure/add.js"></script>
<!-- 添加删除图标按钮 -->
