<#include "../public_header.ftl">
	...
	<script type="text/javascript" src="/static/js/dataDictionary/add.js"></script>
			...
			<form action="" class="layui-form layui-form-pane zq-form">
				...
				<div class="layui-row zq-form-wrap zq-margin-t30">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="parentId" lay-verify="required|number" value="${parentId}" autocomplete="off" class="layui-input"/>
						</div>
					</div>
