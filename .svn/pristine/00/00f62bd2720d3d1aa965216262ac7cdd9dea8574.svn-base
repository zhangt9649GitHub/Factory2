...
public class SalesOrderController {
  ...
  /*  @ApiOperation(value = "更新销售订单状态为已出库", notes = "更新销售订单状态为已出库", tags = {"@郝腾"})
    ...
    @ApiImplicitParam(name = "shipmentListDto", value = "销售订单详情id集合", required = true, dataType = "String")
    @RequestMapping(value = "/exportSalesOrderDetailsList", method = RequestMethod.GET)
    @ResponseBody
    public void exportSalesOrderDetailsList(HttpServletResponse response,String shipmentListDto)
            throws IOException {
        JSONObject dataObj = JSONObject.parseObject(shipmentListDto);
        String shipmentNumber = (String) dataObj.get("shipmentNumber");
        JSONArray jsonArray = JSONArray.fromObject(dataObj.get("salesOrderDetailsListDtos"));
        ...
        ShipmentListDto shipmentListDto1 = new ShipmentListDto();
        shipmentListDto1.setShipmentNumber(shipmentNumber);
        shipmentListDto1.setSalesOrderDetailsListDtos(salesOrderDetailsListDtoList1);
      /*  JSONArray jsonArray = JSONArray.fromObject(shipmentListDto);
        //Java集合
        List<SalesOrderDetailsListDto> salesOrderDetailsListDtoList1 = (List<SalesOrderDetailsListDto>) jsonArray.toCollection(jsonArray, SalesOrderDetailsListDto.class);*/
        List<ShipmentDetails>  shipmentDetailsList  =  salesOrderDetailsService.updateSaleOrderDetailsQuantity(shipmentListDto1);
