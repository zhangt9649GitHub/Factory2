...
public class ProductionInstructionDetail implements Serializable {

    @ApiModelProperty(value = "生产指示书详情id", example = "1")
    private Integer productionInstructionDetailId;
    ...
    @ApiModelProperty(value = "品名", example = "productName")
    private String productName;

    @ApiModelProperty(value = "品种", example = "variety")
    private String variety;

    @ApiModelProperty(value = "必要数", example = "1")
    ...
    public Integer getProductionInstructionDetailId() {
        return productionInstructionDetailId;
    }


    public void setProductionInstructionDetailId(Integer productionInstructionDetailId) {
        this.productionInstructionDetailId = productionInstructionDetailId;
    }
    ...
    public String toString() {
        ...
        sb.append(", productionInstructionDetailId=").append(productionInstructionDetailId);
