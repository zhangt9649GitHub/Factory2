<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/productionPickingDetails/index.css">
	<script type="text/javascript" src="/static/js/productionPickingDetails/index.js"></script>
	...
	<div class="layui-row">
		<div class="bg-1 layui-card">
			<div class="layui-card-header layui-clear">
				<h3 class="left">生产领料明细 <span></span></h3>
