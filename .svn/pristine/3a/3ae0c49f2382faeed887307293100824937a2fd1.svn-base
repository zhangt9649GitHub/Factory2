<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/pickingList/edit.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form" lay-filter="formTest">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-领料单 <span></span></h3>
					...
					<form action="" >
						...
						<div class="layui-row">
							<div class="layui-col-md6">
								<div class="zq-item">
									<label>编号：</label>
									<input type="text" name="pickingNumber" class="layui-input" readonly lay-verify="required">
								</div>
							</div>
							...
							<div class="layui-col-md4">
								<div class="zq-item">
									<label>领出仓库：</label>
									<select name="outWarehouseId" lay-search lay-verify="required" lay-filter="outWarehouseId">
										<option value=""></option>
									</select>
								</div>
							</div>
...
<script type="text/javascript" src="/static/js/pickingList/edit.js"></script>
