<#include "../public_header.ftl">
	...
	<link rel="stylesheet" type="text/css" href="/static/css/listOfProductStructure/edit.css">
	...
	<div class="layui-row">
		...
		<div class="layui-card bg-1 layui-form">
			...
			<div class="layui-card-header layui-clear">
				<h3 class="left">编辑-产品结构表 <span></span></h3>
					...
					<form action="" >
						...
						<div class="layui-row">
							<div class="layui-col-md6">
								<div class="zq-item">
									<label>编号：</label>
									<input type="text" name="bomNumber" readonly lay-verify="required" class="layui-input">
								</div>
							</div>
							<div class="layui-col-md6 zq-text-align-r">
								<div class="zq-item">
									<label>日期：</label>
									<input type="text" name="defineDate" readonly lay-verify="required" class="layui-input" id="laydate-1">
								</div>
							</div>
...
<script type="text/javascript" src="/static/js/listOfProductStructure/edit.js"></script>
<!-- 添加删除图标按钮 -->
